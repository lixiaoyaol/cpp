...
std::vector<float> vec_numx(const std::vector<float> &vec, float a) {
...
std::vector<float> vec_numx(float a, const std::vector<float> &vec) {
    std::vector<float> new_vec(vec.size());
    for(int i=0; i<vec.size(); i++) {
        new_vec[i] = vec[i] * a;
    }
...
std::vector<float> vec_add(const std::vector<float> &vec1, const std::vector<float> &vec2) {
    if(vec1.size() != vec2.size()) {
